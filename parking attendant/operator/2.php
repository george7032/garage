...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $data = array(
        ...
        "Password" => "MTc0Mzc5YmZiMjc5ZjlhYTliZGJjZjE1OGU5N2RkNzFhNDY3Y2QyZTBjODkzMDU5YjEwZjc4ZTZiNzJhZGExZWQyYzkxOTIwMjMwMzI3MTEzNTE5",
        "Timestamp" => "20230327113519",
    ...
    curl_setopt($ch, CURLOPT_HTTPHEADER, [
        'Authorization: Bearer 7RzbxfsU4Q0Nukzf0ybLbL2AEwl1',
...
body {
  ...
  input[type="submit"]:hover {
    ...
    <input type="text" id="partyA" name="partyA" pattern="^254\d{9}$" >
    <br>
